...
export default function Header() {
    ...
    return (
        <div
            className={`${styles.header} ${location.pathname !== '/' ? styles.yellow : ''}`}>
            ...
            <div className={styles.menuItems}>
                    ...
                    <>
                        {menuOpen ? (
                            <div className={styles.mobileMenu}>
                                ...
                                <div className={styles.mobileMenu}>
                                    <div className={`${styles.mobileMenuItems} ${menuOpen ? styles.blur : ''}`}>
                ...
                <Media query={xLargeOrWider}>
                    <React.Fragment>
                        {!isActiveInput && menuItems.map((menuItem, key) => {
                            return (
                                <Link to={`/${menuItem.link}`}
                                      className={`${styles.menuItem} ${location.pathname === `/${menuItem.link}` || location.pathname === `/${menuItem.link}/` ? styles.active : ''}`}
                                      data-menuanchor={
                                          menuItem.section
                                      }
                                      key={key}
                ...
                <div className={styles.lastBlock}>
                    <Link to={"/shopping-bag"}>
                        <div className={styles.bag}>
                            <Bag/>
                            {!!bagItems.length && <div className={styles.count}>{bagItems.length}</div>}
                        </div>
                    </Link>
